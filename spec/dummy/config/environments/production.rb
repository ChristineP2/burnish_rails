...
Rails.application.configure do
  ...
  # ENV["RAILS_MASTER_KEY"] or in config/master.key. This key
  # is used to decrypt credentials (and other encrypted files).
  ...
  # but avoid logging too much information to avoid inadvertent
